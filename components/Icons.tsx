...
export const CoffeeIcon = () => (
  <svg className="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M12 21.5C17.2467 21.5 21.5 17.2467 21.5 12C21.5 6.75329 17.2467 2.5 12 2.5C6.75329 2.5 2.5 6.75329 2.5 12C2.5 17.2467 6.75329 21.5 12 21.5Z" />
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M12 6C9 8.5 9 12.5 12 15C15 17.5 15 19.5 12 21.5" />
  </svg>
);
